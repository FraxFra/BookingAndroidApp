...
public class PrenotationDeleteTask extends AsyncTask<Void, Void, String> {
    ...
    public PrenotationDeleteTask(Context context, String bookingId) {
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            String postData = "operation=ownCancellation&BookingId=" + bookingId + "&Username=" + CustomAccountManager.getLoginCredentials().username;
    ...
    protected void onPostExecute(String result) {
        ...
        if (!Objects.equals(decodedResult.error, "")) {
            ...
            if(!decodedResult.ok) {
                ...
                builder.setMessage("la prenotazione è stata cancellata");
            }
        }
